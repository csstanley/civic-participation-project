...
export default class News extends Component {
    ...
    componentDidMount() {
        ...
        axios({
            method: 'get',
            url: "https://newsapi.org/v2/top-headlines?country=us&apiKey=c45335a9de634b6988f9d7919e631172",
            ...
            <div>
                <div className="container">
                    {this.state.news.map((article, index) => (
                        ...
                        <span key={index}>
                            <h3 className="newsArticles"><a href={article.url}>{article.title}</a> at {article.source.name}</h3>
